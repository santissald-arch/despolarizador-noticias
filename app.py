...
st.set_page_config(page_title="Noticias de Argentina", page_icon="🇦🇷", layout="wide")
...
# ========== NOTICIA DEL DÍA (INFOBAE + TN EN VIVO) ==========
st.markdown("---")
st.subheader("🔥 Noticia del día + TN en vivo")
...
with col_tn:
    ...
    <div style="
        ...
        box-shadow: 0 4px 15px rgba(0,0,0,0.15);
    ">
        <div style="color:#00b4d8; font-weight:700; font-size:14px; margin-bottom:10px;">
            🔵 TN · TRANSMISIÓN EN VIVO (con audio)
        </div>
        ...
        <div style="margin-top:10px; font-size:13px; color:#adb5bd;">
            Señal oficial 24 hs de Todo Noticias · YouTube
        </div>
    </div>
    """, unsafe_allow_html=True)
